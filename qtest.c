...
static void console_init()
{
    ...
    add_int_param("length", &string_length,
                  "Maximum length of displayed string", NULL);
    add_int_param("malloc", &fail_probability,
                  "Malloc failure probability percent", NULL);
    add_int_param("fail", &fail_limit,
                  "Number of times allow queue operations to return false",
                  NULL);
}
